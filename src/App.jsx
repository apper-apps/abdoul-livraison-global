          ...
          <>
            <Route path="/" element={
              <div className="min-h-screen bg-gray-50 relative">
                ...
                />
                <MobileLayout currentRole={currentRole} cartCount={cart.length} />
              </div>
            }>
              ...
              <Route path="profile" element={<ProfilePage currentRole={currentRole} userEmail={user?.emailAddress || user?.email || ''} />} />
